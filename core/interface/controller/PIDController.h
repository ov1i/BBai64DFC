...
private:
  ...
  // helpers
  static float64 apply_deadband_expo(float64 v, float64 deadband, float64 expo);
  static void quat_to_euler312(const float64 q[4], float64& yaw, float64& pitch, float64& roll);
  static void quat_conjugate(const float64 q[4], float64 out[4]);
  static void quat_mul(const float64 a[4], const float64 b[4], float64 out[4]);
  static void quat_to_axis_angle(const float64 q[4], float64 axis[3], float64& angle);
